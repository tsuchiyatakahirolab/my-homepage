    ...
    >
      <div className="mx-auto flex w-full min-h-screen max-w-7xl flex-col justify-center px-6 py-16 sm:py-24 lg:flex-row lg:items-center lg:gap-20 lg:px-12">
        ...
        <motion.div
          ...
          className="relative mb-8 flex aspect-[4/3] w-full max-h-[200px] sm:max-h-[240px] items-center justify-center overflow-hidden sm:aspect-square lg:mb-0 lg:max-h-none lg:aspect-auto lg:min-h-[400px] lg:flex-[2]"
