    ...
    >
      <div className="mx-auto flex w-full min-h-screen max-w-7xl flex-col items-center justify-center px-6 py-16 sm:py-24 lg:flex-row lg:items-center lg:gap-20 lg:px-12">
        ...
        <motion.div
          ...
          className="relative mb-8 flex aspect-square w-2/3 mx-auto items-center justify-center overflow-hidden sm:w-1/2 lg:mx-0 lg:w-auto lg:mb-0 lg:aspect-auto lg:min-h-[400px] lg:flex-[2]"
